  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        solarYellow: "var(--solarYellow)",
        vividPurple: "var(--vividPurple)",
        fieryRed: "var(--fieryRed)",
        tangerineOrange: "var(--tangerineOrange)",
      ...
      backgroundImage: {
        "current-theme": "var(--theme-background)",
      },
      borderColor: {
        "current-theme": "var(--theme-border-color)",
      },
      boxShadow: {
        "current-theme": "var(--theme-shadow)",
      },
    },
  },
